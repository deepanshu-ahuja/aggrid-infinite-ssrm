...
function createNode(id: string, selected: boolean): RowNode<RowData> {
  return {
    data: { id },
 ...
 * selected IDs or page IDs in React state.
 */
describe('InfiniteCurrentPageSelectionHeader', () => {
  it('derives visual state from current-page RowNodes and selects them with native API', () => {
